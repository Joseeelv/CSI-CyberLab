...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', children, fullWidth, className, ...props }, ref) => {
    ...
    const variants = {
      ...
      ghost: "relative px-8 py-2 bg-transparent border border-[rgba(255, 255, 255, 1)] text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-600 hover:shadow-[0_0_18px_rgba(0,232,255,0.5)] hover:scale-105 hover:transition-transform duration-300",
