...
export class SeederService {
  ...
  private async seedImages() {
    const images = [
      { name: 'kali-linux', version: 'latest', operatingSystem: { id: 1 } },
      { name: 'ubuntu', version: '22.04', operatingSystem: { id: 1 } },
      { name: 'debian', version: '11', operatingSystem: { id: 1 } },
      { name: 'windows-server', version: '2022', operatingSystem: { id: 2 } },
    ];
